import{_ as l}from"./plugin-vue_export-helper-c27b6911.js";import{r,o as d,c as t,a as n,b as s,d as e,e as i}from"./app-f330303d.js";const c={},o=i(`<h1 id="初始化" tabindex="-1"><a class="header-anchor" href="#初始化" aria-hidden="true">#</a> 初始化</h1><h2 id="最开始" tabindex="-1"><a class="header-anchor" href="#最开始" aria-hidden="true">#</a> 最开始</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">apt</span> upgrade <span class="token operator">&amp;&amp;</span> <span class="token function">apt</span> update
pkg update
<span class="token function">passwd</span>
<span class="token function">whoami</span>
重置密码 ： <span class="token function">passwd</span> <span class="token parameter variable">-d</span> u0_a311
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-ssh-config line-numbers-mode" data-ext="ssh-config"><pre class="language-ssh-config"><code>vim /etc/profile
